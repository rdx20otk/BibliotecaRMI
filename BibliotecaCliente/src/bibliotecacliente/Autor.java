...
public class Autor extends javax.swing.JFrame {
    ...
    public Autor() {
        ...
        try {
            ...
            interfaz.mostrarAutor();

            while (modelo.getRowCount() > 0) {
                modelo.removeRow(0);
            }
            Object[] fila = new Object[2];
            for (int i = 0; i < interfaz.mostrarAutor().size(); i++) {
                fila[0] = interfaz.mostrarAutor().get(i).getCodigo();
                fila[1] = interfaz.mostrarAutor().get(i).getNombre();
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        try {
            ...
            if (interfaz.buscarAutor(cod).isEmpty()) {

                JOptionPane.showMessageDialog(null, "no encontrado");
            } else {
                txtcodigo.setText(Integer.toString(interfaz.buscarAutor(cod).get(0).getCodigo()));

                txtautor.setText(interfaz.buscarAutor(cod).get(0).getNombre());
                limpiarbuscar();
    ...
    private void btningresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btningresarActionPerformed
        ...
        nom = txtautor.getText();

        try {
            Registry registro = LocateRegistry.getRegistry("127.0.0.1", 4567);
            RMIBD interfaz = (RMIBD) registro.lookup("rmi://localhost:4567");

            interfaz.IngresarAutor(cod, nom);
    ...
    private void btnmodificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnmodificarActionPerformed
        ...
        try {
            Registry registro = LocateRegistry.getRegistry("127.0.0.1", 4567);
            RMIBD interfaz = (RMIBD) registro.lookup("rmi://localhost:4567");
            interfaz.modificarAutor(cod, nom);
