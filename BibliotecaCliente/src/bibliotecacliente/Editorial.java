...
public class Editorial extends javax.swing.JFrame {
    ...
    public Editorial() {
        ...
        try {
            ...
            for (int i = 0; i < interfaz.mostrarEditorial().size(); i++) {
                fila[0] = interfaz.mostrarEditorial().get(i).getCodigo();
                fila[1] = interfaz.mostrarEditorial().get(i).getEditorial();
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        try {
            ...
            if (interfaz.buscarEditorial(cod).isEmpty()) {

                JOptionPane.showMessageDialog(null, "no encontrado");
            } else {

                txtcodigo.setText(Integer.toString(interfaz.buscarEditorial(cod).get(0).getCodigo()));

                txteditorial.setText(interfaz.buscarEditorial(cod).get(0).getEditorial());
                limpiarbuscar();
            }
